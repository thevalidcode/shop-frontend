...
const tourSteps = [
  {
    ...
    description:
      "This is your admin dashboard where you can manage your entire e-commerce shop. Let's take a quick tour to get you familiar with all the features.",
    target: "dashboard",
    icon: Sparkles,
    action: "Start Tour",
  },
  {
    ...
    description:
      "Manage your shop's users, view their profiles, handle permissions, and monitor user activity. This is where you can see all registered customers and their account details.",
    target: "users",
    icon: Users,
    url: "/admin/users",
    action: "View Users",
  ...
  },
  {
    ...
    description:
      "Add, edit, and manage the products you offer to customers. Configure pricing, categories, and product availability from this section.",
    target: "services",
    icon: Shield,
    url: "/admin/products",
  ...
  },
  {
    ...
    description:
      "Configure shipping options, manage shipping methods, and handle delivery settings. Ensure automated, smooth and reliable shipping for your customers.",
  ...
  },
  {
    title: "Shop Settings",
    description:
      "Customize your shop's appearance, configure general settings, and manage shop preferences. This is where you can personalize your brand and functionality.",
    target: "settings",
    icon: Settings,
    url: "/admin/settings",
    action: "Customize Shop",
  },
];
          ...
          <div className="p-8 md:p-10">
            ...
            <div className="mb-10">
              ...
              <div className="w-full bg-muted/50 rounded-full h-3 overflow-hidden">
                <motion.div
                  className="bg-linear-to-r from-primary to-primary/80 h-3 rounded-full shadow-sm"
                  initial={{ width: 0 }}
                  animate={{
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
              <div className="flex items-center space-x-3">
                <Button
                  ...
                  className="min-w-27.5 border-border/50 hover:bg-muted/50"
                >
              ...
              <div className="flex items-center space-x-3">
                {currentStepData.url && currentStep > 0 && (
                  <Button
                    ...
                    className="min-w-35 bg-secondary/80 hover:bg-secondary shadow-sm"
                  >
                ...
                <Button
                  onClick={handleNext}
                  className="min-w-32.5 bg-primary hover:bg-primary/90 shadow-lg hover:shadow-xl transition-all duration-200"
                  size="lg"
                >
