  ...
  return (
    <>
      ...
      <header className="sticky inset-x-0 top-0 z-50 flex w-full flex-wrap text-sm md:flex-nowrap md:justify-start">
        <nav className="relative mx-2 mt-4 w-full max-w-2xl rounded-full border border-gray-200 bg-white py-2.5 md:mx-auto md:flex md:items-center md:justify-between md:px-4 md:py-0">
          <div className="flex items-center justify-between px-4 md:px-0">
            ...
            <div className="md:hidden">
              ...
              <button
                type="button"
                className="hs-collapse-toggle flex size-7 items-center justify-center rounded-full border border-gray-200 text-gray-500 hover:bg-gray-200 focus:bg-gray-200 focus:outline-hidden"
          ...
          >
            <div className="mt-3 flex flex-col gap-2 py-2 md:mt-0 md:flex-row md:items-center md:justify-end md:gap-3 md:py-0 md:ps-7">
              <a
                className="border-s-2 border-gray-800 px-4 py-0.5 font-medium text-gray-800 focus:outline-hidden md:border-s-0 md:border-b-2 md:px-1 md:py-3"
                href="#"
                aria-current="page"
              >
                Home
              ...
              <a
                className="border-s-2 border-transparent px-4 py-0.5 text-gray-500 hover:text-gray-800 focus:outline-hidden md:border-s-0 md:border-b-2 md:px-1 md:py-3"
                href="#"
              >
                Projects
              </a>
