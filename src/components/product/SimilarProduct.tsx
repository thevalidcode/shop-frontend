...
export default function SimilarProduct() {
  return (
    <div className="flex flex-col items-center justify-center w-full px-5 py-5 space-y-6">
      <h1 className="text-black font-medium text-4xl">SIMILAR ITEMS</h1>

      <div className="w-full flex flex-row max-sm:grid max-sm:grid-cols-2 max-sm:flex-col max-sm:space-y-4 space-x-4 max-sm:gap-2 border-0">
        {featuredProducts.map((p: SimilarProduct) => (
