...
import { useUserLogin, useUserVerifySessionCode } from "@/hooks/use-user";
...
export default function Signin() {
      ...
      mutate(
        {
          ...
          shopId: shopId || 0, // Ensure shopId is a number
        },
        {
          onError: (error) => {
  ...
  const handleGoogleLogin = (e: React.FormEvent) => {
    e.preventDefault();
    router.push(
      `https://auth.validpanel.com/api/auth/shop/google?shopId=${shopId}&redirect=https://${domain}/auth/signin`
    );
  };
