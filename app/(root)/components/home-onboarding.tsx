...
import { useUpdateOnboardingCompleted } from "@/hooks/use-shop";
...
export function HomeOnboarding() {
  const { generalSetting, isShopGeneralSettingsLoading } =
    useAppContext();
  ...
  },  [generalSetting, isShopGeneralSettingsLoading]);
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/80 backdrop-blur-sm p-4">
      <Card className="w-full max-w-2xl border shadow-lg max-h-[95vh] overflow-y-auto">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li className="flex items-start gap-2">
                ...
                Complete onboarding and configure your shop
              </li>
            </ul>
          </div>
